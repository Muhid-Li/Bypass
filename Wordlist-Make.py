...
def print_cow():
    print(" ___________ ")
    print(" \033[07m  Muhid.py! \033[27m                # \033[07mC\033[27mommon")
...
def version():
    ...
    print("\r\n	\033[1;31m[ Muhid.py ]  " + __version__ + "\033[1;m\r\n")
...
def improve_dictionary(file_to_open):
    ...
    if leetmode == "y":
        for (
            ...
            unique_lista
        ):  # if you want to add more leet chars, you will need to add more lines in Muhid.cfg too...
    ...
    print_to_file(file_to_open + ".Muhid.txt", unique_list_finished)
...
# the main function
def main():
    """Command-line interface to the Muhid utility"""

    read_config(os.path.join(os.path.dirname(os.path.realpath(__file__)), "Muhid.cfg"))
